...
int main()
{
	...
	cin>>mode;
	UndirectedGraph<int> obj(n,mode);
	while(true)
	{
		cout<<"1.Add Edge"<<endl<<"2.Delete Edge"<<endl<<"3.Check if edge exists"<<endl<<"4.No of edges"<<endl<<"5.No of vertices"<<endl<<"6.Print"<<endl<<"7.Exit"<<endl;
		cin>>e;
		switch(e)
		{
